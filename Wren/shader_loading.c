...
Wren_ShaderProgram Wren_ShaderProgram_create_nn(
	...
	if (-1 == snprintf(vertex_shader_source_path, vertex_shader_source_path_length+1, format_string, vertex_shader_source_name)) {
	...
	if (-1 == snprintf(fragment_shader_source_path, fragment_shader_source_path_length+1, format_string, fragment_shader_source_name)) {
